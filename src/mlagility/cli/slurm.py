...
def run_benchit(
    ...
    compiler_flags_str = list_arg(groq_compiler_flags, "--compiler-flags")
    assembler_flags_str = list_arg(groq_assembler_flags, "--assembler-flags")
    num_chips_str = value_arg(groq_num_chips, "--num-chips")
