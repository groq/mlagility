# labels: test_group::mlagility name::facebook_hubert_base_ls960 author::huggingface_keras
"""
...
config = transformers.AutoConfig.from_pretrained("facebook/hubert-base-ls960")
