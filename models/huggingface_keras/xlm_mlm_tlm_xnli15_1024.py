# labels: test_group::mlagility name::xlm_mlm_tlm_xnli15_1024 author::huggingface_keras
"""
...
config = transformers.AutoConfig.from_pretrained("xlm-mlm-tlm-xnli15-1024")
