# labels: test_group::mlagility name::google_mobilebert_uncased author::huggingface_keras
"""
...
config = transformers.AutoConfig.from_pretrained("google/mobilebert-uncased")
