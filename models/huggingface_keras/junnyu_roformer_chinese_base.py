# labels: test_group::mlagility name::junnyu_roformer_chinese_base author::huggingface_keras
"""
...
config = transformers.AutoConfig.from_pretrained("junnyu/roformer_chinese_base")
