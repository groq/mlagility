# labels: test_group::mlagility name::unc_nlp_lxmert_base_uncased author::huggingface_keras
"""
...
config = transformers.AutoConfig.from_pretrained("unc-nlp/lxmert-base-uncased")
