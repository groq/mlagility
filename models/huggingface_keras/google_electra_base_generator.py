# labels: test_group::mlagility name::google_electra_base_generator author::huggingface_keras
"""
...
config = transformers.AutoConfig.from_pretrained("google/electra-base-generator")
