# labels: test_group::mlagility name::facebook_convnext_tiny_224 author::huggingface_keras
"""
...
config = transformers.AutoConfig.from_pretrained("facebook/convnext-tiny-224")
