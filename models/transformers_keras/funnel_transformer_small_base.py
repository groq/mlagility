# labels: test_group::mlagility name::funnel_transformer_small_base author::huggingface_keras
"""
...
config = transformers.AutoConfig.from_pretrained("funnel-transformer/small-base")
